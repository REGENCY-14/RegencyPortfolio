    ...
    <header className="sticky top-0 z-50 w-full">
      ...
      <div className="relative mx-auto flex h-20 w-full max-w-(--container-page) items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          <span className="hidden items-center gap-2 rounded-full border border-hairline px-3 py-1.5 text-xs text-muted lg:flex">
            <span className="size-1.5 rounded-full bg-accent-glow motion-safe:animate-pulse" aria-hidden />
